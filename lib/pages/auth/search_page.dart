...
import 'package:chat_app/widgets/group_tille.dart';
...
class _SearchPageState extends State<SearchPage> {
  ...
  Widget groupTile(
    ...
    // function to check if user existes in group
    ...
    return ListTile(
      ...
      trailing: InkWell(
        onTap: () async {
          DatabaseService(uid: user!.uid).toggleGroupJoin(groupId, userName, groupName);
          if(isJoined){
            setState(() {
              isJoined = !isJoined;
